...
// End Cross Module References
	...
	DEFINE_FUNCTION(AGameMode::execHasMatchEnded)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game" },
		{ "Comment", "/** Returns true if the match state is WaitingPostMatch or later */" },
		{ "ModuleRelativePath", "Classes/GameFramework/GameMode.h" },
		{ "ToolTip", "Returns true if the match state is WaitingPostMatch or later" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGameMode, nullptr, "HasMatchEnded", nullptr, nullptr, sizeof(GameMode_eventHasMatchEnded_Parms), Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AGameMode_HasMatchEnded_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGameMode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AGameMode_HasMatchEnded, "HasMatchEnded" }, // 2868976797
	...
	IMPLEMENT_CLASS(AGameMode, 456858961);
