...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVectorFieldStatic_Statics::NewProp_CPUData_MetaData[] = {
		{ "Comment", "/** Local copy of the source vector data. */" },
		{ "ModuleRelativePath", "Classes/VectorField/VectorFieldStatic.h" },
		{ "ToolTip", "Local copy of the source vector data." },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVectorFieldStatic_Statics::NewProp_CPUData = { "CPUData", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVectorFieldStatic, CPUData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UVectorFieldStatic_Statics::NewProp_CPUData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVectorFieldStatic_Statics::NewProp_CPUData_MetaData)) };
	...
	IMPLEMENT_CLASS(UVectorFieldStatic, 2180583806);
