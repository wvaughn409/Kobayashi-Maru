...
static struct FScriptStruct_Engine_StaticRegisterNativesFTireFrictionScalePair
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** DEPRECATED Pairs desired tire friction scale with tire type */" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_FrictionScale_MetaData[] = {
		{ "Comment", "/** Friction scale for this type of tire */" },
		{ "ModuleRelativePath", "Classes/PhysicalMaterials/PhysicalMaterial.h" },
		{ "ToolTip", "Friction scale for this type of tire" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_FrictionScale = { "FrictionScale", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTireFrictionScalePair, FrictionScale), METADATA_PARAMS(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_FrictionScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_FrictionScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_TireType = { "TireType", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTireFrictionScalePair, TireType), Z_Construct_UClass_UTireType_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_TireType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::NewProp_TireType_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTireFrictionScalePair_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FTireFrictionScalePair_Hash() { return 578890193U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicalMaterial_Statics::NewProp_TireFrictionScales_MetaData[] = {
		{ "Category", "Deprecated" },
		{ "Comment", "/** DEPRECATED - Tire friction scales for specific types of tires. These values are multiplied against our parents' values. */" },
		{ "ModuleRelativePath", "Classes/PhysicalMaterials/PhysicalMaterial.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicalMaterial_Statics::NewProp_TireFrictionScale_MetaData[] = {
		{ "Category", "Deprecated" },
		{ "Comment", "/** DEPRECATED - Overall tire friction scalar for every type of tire. This value is multiplied against our parents' values. */" },
		{ "ModuleRelativePath", "Classes/PhysicalMaterials/PhysicalMaterial.h" },
	...
	IMPLEMENT_CLASS(UPhysicalMaterial, 3705835677);
