...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ECopyType_Hash() { return 1392451914U; }
	UEnum* Z_Construct_UEnum_Engine_ECopyType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "ECopyType::PlainProperty", (int64)ECopyType::PlainProperty },
				...
				{ "ECopyType::NameProperty", (int64)ECopyType::NameProperty },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BoolProperty.Comment", "// Read and write properties using bool property helpers, as source/dest could be bitfield or boolean\n" },
				{ "BoolProperty.Name", "ECopyType::BoolProperty" },
				...
				{ "NameProperty.Comment", "// FName needs special case because its size changes between editor/compiler and runtime.\n" },
				{ "NameProperty.Name", "ECopyType::NameProperty" },
				{ "NameProperty.ToolTip", "FName needs special case because its size changes between editor/compiler and runtime." },
				{ "ObjectProperty.Comment", "// Read and write properties using object property helpers, as source/dest could be regular/weak/lazy etc.\n" },
				{ "ObjectProperty.Name", "ECopyType::ObjectProperty" },
				...
				{ "PlainProperty.Comment", "// For plain old data types, we do a simple memcpy.\n" },
				{ "PlainProperty.Name", "ECopyType::PlainProperty" },
				{ "PlainProperty.ToolTip", "For plain old data types, we do a simple memcpy." },
				{ "StructProperty.Comment", "// Use struct copy operation, as this needs to correctly handle CPP struct ops\n" },
				{ "StructProperty.Name", "ECopyType::StructProperty" },
	...
	uint32 Get_Z_Construct_UEnum_Engine_EPostCopyOperation_Hash() { return 2215019677U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EPinHidingMode_Hash() { return 639613564U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFExposedValueHandler
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FExposedValueHandler_Hash() { return 1158861710U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFExposedValueCopyRecord
{
...
#endif
		static const UE4CodeGen_Private::FFieldPathPropertyParams NewProp_CachedSourceStructSubProperty;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CachedSourceProperty_MetaData[];
#endif
		static const UE4CodeGen_Private::FFieldPathPropertyParams NewProp_CachedSourceProperty;
#if WITH_METADATA
...
#endif
		static const UE4CodeGen_Private::FFieldPathPropertyParams NewProp_DestProperty;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFieldPathPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceStructSubProperty = { "CachedSourceStructSubProperty", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::FieldPath, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, CachedSourceStructSubProperty), &FProperty::StaticClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceStructSubProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceStructSubProperty_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceProperty_MetaData[] = {
		{ "Comment", "// cached source property\n" },
		{ "ModuleRelativePath", "Classes/Animation/AnimNodeBase.h" },
		{ "ToolTip", "cached source property" },
	};
#endif
	const UE4CodeGen_Private::FFieldPathPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceProperty = { "CachedSourceProperty", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::FieldPath, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, CachedSourceProperty), &FProperty::StaticClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CachedSourceProperty_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_Size = { "Size", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, Size), METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_Size_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_Size_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFieldPathPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_DestProperty = { "DestProperty", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::FieldPath, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, DestProperty), &FProperty::StaticClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_DestProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_DestProperty_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyType = { "CopyType", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, CopyType), Z_Construct_UEnum_Engine_ECopyType, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyType_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_bInstanceIsTarget_MetaData[] = {
		{ "Comment", "// Whether or not the anim instance object is the target for the copy instead of a node.\n" },
		{ "ModuleRelativePath", "Classes/Animation/AnimNodeBase.h" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_bInstanceIsTarget = { "bInstanceIsTarget", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FExposedValueCopyRecord), &Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_bInstanceIsTarget_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_bInstanceIsTarget_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_bInstanceIsTarget_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_SourceArrayIndex = { "SourceArrayIndex", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, SourceArrayIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_SourceArrayIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_SourceArrayIndex_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FExposedValueCopyRecord_Hash() { return 3554832640U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPoseLinkBase
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FPoseLinkBase_Hash() { return 2581232145U; }
