...
static struct FScriptStruct_Engine_StaticRegisterNativesFMaterialSpriteElement
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMaterialSpriteElement_Hash() { return 2787758368U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMaterialBillboardComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMaterialBillboardComponent_AddElement, "AddElement" }, // 2504494122
		{ &Z_Construct_UFunction_UMaterialBillboardComponent_SetElements, "SetElements" }, // 3282021635
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMaterialBillboardComponent, 1225454680);
