...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialDomain_Hash() { return 3742146547U; }
	UEnum* Z_Construct_UEnum_Engine_EMaterialDomain()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "MD_RuntimeVirtualTexture.Comment", "/** The material will be used for runtime virtual texture */" },
				{ "MD_RuntimeVirtualTexture.DisplayName", "Virtual Texture" },
				{ "MD_RuntimeVirtualTexture.Name", "MD_RuntimeVirtualTexture" },
				{ "MD_RuntimeVirtualTexture.ToolTip", "The material will be used for runtime virtual texture" },
