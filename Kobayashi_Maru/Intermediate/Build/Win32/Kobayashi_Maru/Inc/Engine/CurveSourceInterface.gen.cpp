...
static struct FScriptStruct_Engine_StaticRegisterNativesFNamedCurveValue
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedCurveValue_Hash() { return 4001878409U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveSourceInterface_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCurveSourceInterface_GetCurves, "GetCurves" }, // 2407402282
		{ &Z_Construct_UFunction_UCurveSourceInterface_GetCurveValue, "GetCurveValue" }, // 2734704383
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCurveSourceInterface, 288107394);
