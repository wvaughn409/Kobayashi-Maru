...
static struct FScriptStruct_Landscape_StaticRegisterNativesFLandscapeSplineConnection
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FLandscapeSplineConnection_Hash() { return 2098929970U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureMainPassMaxDrawDistance = { "VirtualTextureMainPassMaxDrawDistance", nullptr, (EPropertyFlags)0x0010040800000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeSplineControlPoint, VirtualTextureMainPassMaxDrawDistance), METADATA_PARAMS(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureMainPassMaxDrawDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureMainPassMaxDrawDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureCullMips = { "VirtualTextureCullMips", nullptr, (EPropertyFlags)0x0010040800000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeSplineControlPoint, VirtualTextureCullMips), METADATA_PARAMS(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureCullMips_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureCullMips_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureLodBias = { "VirtualTextureLodBias", nullptr, (EPropertyFlags)0x0010040800000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeSplineControlPoint, VirtualTextureLodBias), METADATA_PARAMS(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureLodBias_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_VirtualTextureLodBias_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_RuntimeVirtualTextures_MetaData[] = {
		{ "Category", "VirtualTexture" },
		{ "Comment", "/** \n\x09 * Array of runtime virtual textures into which we render the spline segment. \n\x09 * The material also needs to be set up to output to a virtual texture. \n\x09 */" },
		{ "DisplayName", "Render to Virtual Textures" },
		{ "ModuleRelativePath", "Classes/LandscapeSplineControlPoint.h" },
		{ "ToolTip", "Array of runtime virtual textures into which we render the spline segment.\nThe material also needs to be set up to output to a virtual texture." },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_RuntimeVirtualTextures = { "RuntimeVirtualTextures", nullptr, (EPropertyFlags)0x0010000800000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeSplineControlPoint, RuntimeVirtualTextures), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_RuntimeVirtualTextures_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeSplineControlPoint_Statics::NewProp_RuntimeVirtualTextures_MetaData)) };
	...
	IMPLEMENT_CLASS(ULandscapeSplineControlPoint, 4000537850);
