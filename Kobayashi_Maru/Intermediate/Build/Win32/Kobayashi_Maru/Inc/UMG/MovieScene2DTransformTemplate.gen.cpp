...
static struct FScriptStruct_UMG_StaticRegisterNativesFMovieScene2DTransformSectionTemplate
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::NewProp_Shear = { "Shear", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(Shear, FMovieScene2DTransformSectionTemplate), STRUCT_OFFSET(FMovieScene2DTransformSectionTemplate, Shear), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::NewProp_Shear_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::NewProp_Shear_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene2DTransformSectionTemplate_Hash() { return 2570605121U; }
