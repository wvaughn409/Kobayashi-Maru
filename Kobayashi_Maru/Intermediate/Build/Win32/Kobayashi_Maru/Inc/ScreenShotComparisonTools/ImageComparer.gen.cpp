...
static struct FScriptStruct_ScreenShotComparisonTools_StaticRegisterNativesFImageComparisonResult
{
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportIncomingFile = { "ReportIncomingFile", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FImageComparisonResult, ReportIncomingFile), METADATA_PARAMS(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportIncomingFile_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportIncomingFile_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportApprovedFile = { "ReportApprovedFile", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FImageComparisonResult, ReportApprovedFile), METADATA_PARAMS(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportApprovedFile_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ReportApprovedFile_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ComparisonFile = { "ComparisonFile", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FImageComparisonResult, ComparisonFile), METADATA_PARAMS(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ComparisonFile_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_ComparisonFile_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_IncomingFile = { "IncomingFile", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FImageComparisonResult, IncomingFile), METADATA_PARAMS(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_IncomingFile_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageComparisonResult_Statics::NewProp_IncomingFile_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FImageComparisonResult_Hash() { return 4589269U; }
...
static struct FScriptStruct_ScreenShotComparisonTools_StaticRegisterNativesFImageTolerance
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FImageTolerance_Hash() { return 3898014878U; }
