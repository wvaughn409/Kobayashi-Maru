...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Localization_ELocTextPlatformSplitMode_Hash() { return 1835669813U; }
	UEnum* Z_Construct_UEnum_Localization_ELocTextPlatformSplitMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "Restricted.Comment", "/** Split platform specific localization data for restricted platforms only */" },
				{ "Restricted.Name", "ELocTextPlatformSplitMode::Restricted" },
