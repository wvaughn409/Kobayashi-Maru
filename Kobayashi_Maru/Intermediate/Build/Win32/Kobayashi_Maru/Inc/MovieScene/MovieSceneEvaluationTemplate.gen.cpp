...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationTemplate
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_TrackFieldData = { "TrackFieldData", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationTemplate, TrackFieldData), Z_Construct_UScriptStruct_FMovieSceneTrackFieldData, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_TrackFieldData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_TrackFieldData_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_EvaluationField_MetaData[] = {
		{ "Comment", "/** Evaluation field for efficient runtime evaluation */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTemplate.h" },
		{ "ToolTip", "Evaluation field for efficient runtime evaluation" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_EvaluationField = { "EvaluationField", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationTemplate, EvaluationField), Z_Construct_UScriptStruct_FMovieSceneEvaluationField, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_EvaluationField_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_EvaluationField_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Hash() { return 1480929204U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSubSectionFieldData
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneSubSectionFieldData_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Custom serialized track field data that allows efficient lookup of each sub section contained within this template for a given time */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTemplate.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneSubSectionFieldData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSubSectionFieldData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSubSectionFieldData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSubSectionFieldData_Hash() { return 318387906U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSubSectionData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSubSectionData_Hash() { return 2868658951U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackFieldData
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneTrackFieldData_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Custom serialized track field data that allows efficient lookup of each track contained within this template for a given time */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTemplate.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneTrackFieldData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTrackFieldData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTrackFieldData_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackFieldData_Hash() { return 4213195747U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTemplateGenerationLedger
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger_Hash() { return 3240233377U; }
