...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_EEvaluationMethod_Hash() { return 3858884650U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationTrack
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationTrack_Hash() { return 1008928343U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationTrackSegments
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Structure that references a sorted array of segments by indirect identifiers */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTrack.h" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::NewProp_SortedSegments = { "SortedSegments", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationTrackSegments, SortedSegments), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::NewProp_SortedSegments_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::NewProp_SortedSegments_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::NewProp_SegmentIdentifierToIndex_MetaData[] = {
		{ "Comment", "/** Array of indices into SortedSegments where each FMovieSceneSegmentIdentifier represents and index into SegmentIdentifierToIndex. Never shuffled until the container is reset. */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTrack.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationTrackSegments_Hash() { return 1370497288U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFSectionEvaluationDataTree
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSectionEvaluationDataTree_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Custom serialized tree of section evaluation data for a track */" },
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationTrack.h" },
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSectionEvaluationDataTree_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSectionEvaluationDataTree_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSectionEvaluationDataTree_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSectionEvaluationDataTree_Hash() { return 2516203610U; }
