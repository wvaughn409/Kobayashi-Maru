...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UMovieScene3DAttachSection_Statics::NewProp_ReAttachOnDetach = { "ReAttachOnDetach", nullptr, (EPropertyFlags)0x0014000800000005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene3DAttachSection, ReAttachOnDetach), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DAttachSection_Statics::NewProp_ReAttachOnDetach_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DAttachSection_Statics::NewProp_ReAttachOnDetach_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieScene3DAttachSection, 2791008427);
