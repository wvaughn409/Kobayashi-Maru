...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneCameraCutSectionTemplate
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bIsFinalSection_MetaData[];
#endif
		static void NewProp_bIsFinalSection_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsFinalSection;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/** Camera cut track evaluation template */" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection_MetaData[] = {
		{ "ModuleRelativePath", "Private/Evaluation/MovieSceneCameraCutTemplate.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection_SetBit(void* Obj)
	{
		((FMovieSceneCameraCutSectionTemplate*)Obj)->bIsFinalSection = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection = { "bIsFinalSection", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieSceneCameraCutSectionTemplate), &Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CutTransform = { "CutTransform", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneCameraCutSectionTemplate, CutTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CutTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CutTransform_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CameraBindingID_MetaData[] = {
		{ "Comment", "/** GUID of the camera we should cut to in this sequence */" },
		{ "ModuleRelativePath", "Private/Evaluation/MovieSceneCameraCutTemplate.h" },
		{ "ToolTip", "GUID of the camera we should cut to in this sequence" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CameraBindingID = { "CameraBindingID", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneCameraCutSectionTemplate, CameraBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CameraBindingID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_CameraBindingID_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::NewProp_bIsFinalSection,
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneCameraCutSectionTemplate_Hash() { return 2231493958U; }
