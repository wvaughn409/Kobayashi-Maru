...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneComponentTransformSectionTemplate
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneComponentTransformSectionTemplate_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComponentTransformSectionTemplate_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000005),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneComponentTransformSectionTemplate_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComponentTransformSectionTemplate_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneComponentTransformSectionTemplate_Hash() { return 1886872174U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DTransformTemplateData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DTransformTemplateData_Hash() { return 4255487934U; }
