...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::NewProp_DirectorBlueprint_MetaData[] = {
		{ "Comment", "/** Legacy pointer to the sequence director BP */" },
		{ "ModuleRelativePath", "Public/Sections/MovieSceneEventSectionBase.h" },
		{ "ToolTip", "Legacy pointer to the sequence director BP" },
	};
#endif
	const UE4CodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::NewProp_DirectorBlueprint = { "DirectorBlueprint", nullptr, (EPropertyFlags)0x0044000820000000, UE4CodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventSectionBase, DirectorBlueprint_DEPRECATED), Z_Construct_UClass_UBlueprint_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::NewProp_DirectorBlueprint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::NewProp_DirectorBlueprint_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::ClassParams = {
		...
		0,
		IF_WITH_EDITORONLY_DATA(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventSectionBase_Statics::PropPointers), 0),
		0,
		0x002800A0u,
	...
	IMPLEMENT_CLASS(UMovieSceneEventSectionBase, 1884711616);
