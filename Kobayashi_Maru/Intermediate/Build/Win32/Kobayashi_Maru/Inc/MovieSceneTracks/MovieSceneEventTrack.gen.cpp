...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieSceneTracks_EFireEventsAtPosition_Hash() { return 4036035994U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEventTrack_Statics::NewProp_EventReceivers_MetaData[] = {
		{ "Category", "TrackEvent" },
		{ "Comment", "/** Defines a list of object bindings on which to trigger the events in this track. When empty, events will trigger in the default event contexts for the playback environment (such as the level blueprint, or widget). */" },
		{ "ModuleRelativePath", "Public/Tracks/MovieSceneEventTrack.h" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneEventTrack_Statics::NewProp_EventReceivers = { "EventReceivers", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventTrack, EventReceivers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventTrack_Statics::NewProp_EventReceivers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventTrack_Statics::NewProp_EventReceivers_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieSceneEventTrack, 2671611812);
