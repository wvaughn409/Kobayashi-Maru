...
static struct FScriptStruct_AugmentedReality_StaticRegisterNativesFARSharedWorldReplicationState
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FARSharedWorldReplicationState_Hash() { return 3717326386U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AARSharedWorldGameMode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetARSharedWorldData, "SetARSharedWorldData" }, // 2198307604
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetARWorldSharingIsReady, "SetARWorldSharingIsReady" }, // 3768277565
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetPreviewImageData, "SetPreviewImageData" }, // 1500967926
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AARSharedWorldGameMode, 1596058627);
