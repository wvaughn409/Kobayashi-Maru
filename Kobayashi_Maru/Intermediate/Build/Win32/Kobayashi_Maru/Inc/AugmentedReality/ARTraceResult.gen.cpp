...
static struct FScriptStruct_AugmentedReality_StaticRegisterNativesFARTraceResult
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalToTrackingTransform_MetaData[] = {
		{ "Comment", "/**\n\x09 * The transformation matrix that defines the intersection's rotation, translation and scale\n\x09 * relative to the world.\n\x09 */" },
		{ "ModuleRelativePath", "Public/ARTraceResult.h" },
		{ "ToolTip", "The transformation matrix that defines the intersection's rotation, translation and scale\nrelative to the world." },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalToTrackingTransform = { "LocalToTrackingTransform", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARTraceResult, LocalToTrackingTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalToTrackingTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalToTrackingTransform_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FARTraceResult_Hash() { return 3780255035U; }
