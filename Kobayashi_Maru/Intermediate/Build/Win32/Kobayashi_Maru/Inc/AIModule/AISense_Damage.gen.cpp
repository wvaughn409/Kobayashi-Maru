...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIDamageEvent
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIDamageEvent_Hash() { return 2247546107U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Damage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Damage_ReportDamageEvent, "ReportDamageEvent" }, // 1156198397
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAISense_Damage, 4219719931);
