...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIPredictionEvent
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIPredictionEvent_Hash() { return 3830619713U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Prediction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestControllerPredictionEvent, "RequestControllerPredictionEvent" }, // 548848858
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent, "RequestPawnPredictionEvent" }, // 2501304608
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAISense_Prediction, 3763230577);
