...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAISystem_Statics::NewProp_bEnableBTAITasks_MetaData[] = {
		...
		{ "Comment", "/** this property is just a transition-time flag - in the end we're going to switch over to Gameplay Tasks anyway, that's the goal. */" },
		{ "ModuleRelativePath", "Classes/AISystem.h" },
	...
	IMPLEMENT_CLASS(UAISystem, 1731073507);
