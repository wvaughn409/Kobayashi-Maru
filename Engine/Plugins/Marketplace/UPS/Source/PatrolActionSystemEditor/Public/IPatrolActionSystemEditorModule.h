 ...
 */
class IPatrolActionSystemEditorModule : public IModuleInterface
{
...
public:
	 ...
	 */
	static inline IPatrolActionSystemEditorModule& Get()
	{
		return FModuleManager::LoadModuleChecked< IPatrolActionSystemEditorModule >( "PatrolActionSystemEditor" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "PatrolActionSystemEditor" );
	}
