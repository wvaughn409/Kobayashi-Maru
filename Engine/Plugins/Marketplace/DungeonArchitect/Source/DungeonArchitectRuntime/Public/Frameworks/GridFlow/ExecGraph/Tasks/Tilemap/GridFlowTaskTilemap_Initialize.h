...
class DUNGEONARCHITECTRUNTIME_API UGridFlowTaskTilemap_Initialize : public UGridFlowExecTask {
    GENERATED_BODY()
...
private:
    ...
    void PerturbRoomSizes(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap,
                          const FGridFlowAbstractGraphQuery& GraphQuery, const FRandomStream& Random);
    void FixCorridorSizes(FGridFlowTilemapNodes& TileNodes, const FGridFlowAbstractGraphQuery& GraphQuery);
    ...
    void GenerateMainPath(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap,
                          const FGridFlowAbstractGraphQuery& GraphQuery);
    bool ShouldBlockCaveBoundary(UGridFlowAbstractGraph* Graph, FGridFlowAbstractNode* CaveNode, int dx, int dy);
    FIntPoint NodeCoordToTileCoord(const FIntPoint& NodeCoord);
    ...
    void BuildCaves(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap,
                    const FGridFlowAbstractGraphQuery& GraphQuery, const FRandomStream& Random);
    void GenerateCaveMap(FGFCaveCellBuildTiles& CaveMap, FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap,
                         const FGridFlowAbstractGraphQuery& GraphQuery);
    ...
    void BuildCaveStep_Cleanup(FGFCaveCellBuildTiles& CaveMap, FGridFlowTilemapNodes& TileNodes,
                               UGridFlowTilemap* Tilemap, const FGridFlowAbstractGraphQuery& GraphQuery);
    void BuildCaveStep_UpdateEdges(FGFCaveCellBuildTiles& CaveMap, UGridFlowTilemap* Tilemap);
    
private:
    FIntPoint LayoutGridSize;
    void BuildDoors(FGridFlowTilemapNodes& TileNodes, UGridFlowTilemap* Tilemap,
                    const FGridFlowAbstractGraphQuery& GraphQuery);
    UGridFlowTilemap* ApplyCropAndPadding(UGridFlowTilemap* Tilemap);
    void CalculateDistanceFromMainPathOnEmptyArea(UGridFlowTilemap* Tilemap);
};
