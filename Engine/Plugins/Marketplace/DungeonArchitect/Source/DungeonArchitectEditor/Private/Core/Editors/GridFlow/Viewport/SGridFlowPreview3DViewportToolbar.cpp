...
void SGridFlowPreview3DViewportToolbar::Construct(const FArguments& InArgs) {
    Viewport = InArgs._Viewport;

    TSharedRef<SGridFlowPreview3DViewport> ViewportRef = Viewport.Pin().ToSharedRef();
        ...
        [
            ...
            [
                ...
                [
					...
					.OnGetMenuContent(this, &SGridFlowPreview3DViewportToolbar::GeneratePropertiesMenu)
                ]
                + SHorizontalBox::Slot()
                  .AutoWidth()
                  .Padding(ToolbarSlotPadding)
                [
					...
					.OnGetMenuContent(this, &SGridFlowPreview3DViewportToolbar::GenerateCameraMenu)
                ]
                + SHorizontalBox::Slot()
                  .AutoWidth()
                  .Padding(ToolbarSlotPadding)
...
TSharedRef<SWidget> SGridFlowPreview3DViewportToolbar::GeneratePropertiesMenu() const {
...
TSharedRef<SWidget> SGridFlowPreview3DViewportToolbar::GenerateCameraMenu() const {
    const bool bInShouldCloseWindowAfterMenuSelection = true;
...
TSharedPtr<FExtender> SGridFlowPreview3DViewportToolbar::GetViewMenuExtender() {
