...
public:
    ...
    void GeneratePreviewTexture(UGridFlowTilemap* InTilemap, const FGridFlowTilemapRendererSettings& InRenderSettings,
                                const TArray<FGridFlowItem>& InItems);
...
public:
    ...
    void SetItemInfo(const TMap<FGuid, FGridFlowTilemapCoord>& InTileItems, const TMap<FGuid, FGridFlowItem>& InItemList);
    void ClearItemInfo();
...
public:
    ...
    TMap<FGuid, FGridFlowItem> ItemList;
};
...
public:
    FGridFlowTilemapConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor,
                                            ...
                                            UEdGraph* InGraphObj);
    void Draw(TMap<TSharedRef<SWidget>, FArrangedWidget>& InPinGeometries, FArrangedChildren& InArrangedNodes) override;
    void DrawSplineWithArrow(const FGeometry& StartGeom, const FGeometry& EndGeom,
                             const FConnectionParams& Params) override;
    void DrawSplineWithArrow(const FVector2D& StartPoint, const FVector2D& EndPoint,
                             const FConnectionParams& Params) override;
    void DrawConnection(int32 LayerId, const FVector2D& Start, const FVector2D& End,
                        const FConnectionParams& Params) override;
