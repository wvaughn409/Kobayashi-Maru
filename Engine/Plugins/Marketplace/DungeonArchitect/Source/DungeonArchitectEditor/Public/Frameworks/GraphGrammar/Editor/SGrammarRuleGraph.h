...
public:
    void OnNodeTypeDrop(TSharedPtr<FDragDropOperation> Operation, const FVector2D& InDropPosition,
                        TSharedPtr<SGraphEditor> GraphEditor, TWeakObjectPtr<UEdGraph> Graph) override;
    bool OnNodeTypeAllowDrop(TSharedPtr<FDragDropOperation> Operation, TSharedPtr<SGraphEditor> GraphEditor,
                             TWeakObjectPtr<UEdGraph> Graph) override;
    bool OnIsNodeTypeDropRecognized(TSharedPtr<FDragDropOperation> Operation, TSharedPtr<SGraphEditor> GraphEditor,
                                    TWeakObjectPtr<UEdGraph> Graph) override;
};
