...
public:
    ...
    FLaunchPadTextResourcePtr GetText(const FString& InPath) override;

protected:
    const FSlateBrush* GetImageImpl(const FString& InPath, const FVector2D& InImageSize) override;
