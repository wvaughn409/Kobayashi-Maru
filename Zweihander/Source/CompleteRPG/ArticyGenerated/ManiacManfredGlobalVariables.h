...
class COMPLETERPG_API UManiacManfredGameStateVariables : public UArticyBaseVariableSet
{
	GENERATED_BODY()
...
public:
	...
	/** true after befriending this NPC */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* friendOfNiallghas = nullptr;
	/** true after befriending this NPC */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* friendOfBrianan = nullptr;
	/** true after befriending this NPC */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* friendOfLachlainn = nullptr;
	/** true after befriending this NPC */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* friendOfEarc = nullptr;
	/** true after befriending this NPC */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* friendOfAngaidh = nullptr;
	/** this is a default boolean and is false SHOULD NOT CHANGE */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Instanced, Category="GameState")
	UArticyBool* defaultFalse = nullptr;
	 ...
	 UManiacManfredGameStateVariables() 
	{
		...
		friendOfNiallghas = CreateDefaultSubobject<UArticyBool>("friendOfNiallghas");
		friendOfBrianan = CreateDefaultSubobject<UArticyBool>("friendOfBrianan");
		friendOfLachlainn = CreateDefaultSubobject<UArticyBool>("friendOfLachlainn");
		friendOfEarc = CreateDefaultSubobject<UArticyBool>("friendOfEarc");
		friendOfAngaidh = CreateDefaultSubobject<UArticyBool>("friendOfAngaidh");
		defaultFalse = CreateDefaultSubobject<UArticyBool>("defaultFalse");
	}
	...
	void Init(UArticyGlobalVariables* const Store) 
	{
		...
		friendOfNiallghas->Init<UArticyBool>(this, Store, TEXT("GameState.friendOfNiallghas"), false);
		this->Variables.Add(friendOfNiallghas);
		friendOfBrianan->Init<UArticyBool>(this, Store, TEXT("GameState.friendOfBrianan"), false);
		this->Variables.Add(friendOfBrianan);
		friendOfLachlainn->Init<UArticyBool>(this, Store, TEXT("GameState.friendOfLachlainn"), false);
		this->Variables.Add(friendOfLachlainn);
		friendOfEarc->Init<UArticyBool>(this, Store, TEXT("GameState.friendOfEarc"), false);
		this->Variables.Add(friendOfEarc);
		friendOfAngaidh->Init<UArticyBool>(this, Store, TEXT("GameState.friendOfAngaidh"), false);
		this->Variables.Add(friendOfAngaidh);
		defaultFalse->Init<UArticyBool>(this, Store, TEXT("GameState.defaultFalse"), false);
		this->Variables.Add(defaultFalse);
	}
};

UCLASS(BlueprintType)
class COMPLETERPG_API UManiacManfredInventoryVariables : public UArticyBaseVariableSet
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class COMPLETERPG_API UManiacManfredGlobalVariables : public UArticyGlobalVariables
{
	GENERATED_BODY()
